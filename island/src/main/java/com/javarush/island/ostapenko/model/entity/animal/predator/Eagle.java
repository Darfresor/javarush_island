...
public class Eagle extends Animal {
    ...
    private static final float MAX_WEIGHT_IN_KG = 6;
    private static final int MAX_CREATURE_IN_CELL = 20;
    private static final int CELL_PER_TURN = 3;
    private static final float FOOD_TO_BE_SATIATED_IN_KG = 1;


    public Eagle(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfEagleInCell(){
        return MAX_CREATURE_IN_CELL;
    }
