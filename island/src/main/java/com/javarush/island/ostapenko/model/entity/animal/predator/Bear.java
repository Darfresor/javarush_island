...
public class Bear extends Animal {
    ...
    private static final float MAX_WEIGHT_IN_KG = 500;
    private static final int MAX_CREATURE_IN_CELL = 5;
    private static final int CELL_PER_TURN = 2;
    private static final float FOOD_TO_BE_SATIATED_IN_KG = 80;


    public Bear(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfBearInCell(){
        return MAX_CREATURE_IN_CELL;
    }
