...
public class Deer extends Animal {
    ...
    private static final float MAX_WEIGHT_IN_KG = 300;
    ...
    public Deer(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfDeerInCell(){
        return MAX_CREATURE_IN_CELL;
    }
