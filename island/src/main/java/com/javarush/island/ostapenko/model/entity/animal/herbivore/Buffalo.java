...
public class Buffalo extends Animal {
    ...
    private static final float MAX_WEIGHT_IN_KG = 700;
    private static final int MAX_CREATURE_IN_CELL = 10;
    private static final int CELL_PER_TURN = 3;
    private static final float FOOD_TO_BE_SATIATED_IN_KG = 100;


    public Buffalo(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfBuffaloInCell(){
        return MAX_CREATURE_IN_CELL;
    }
