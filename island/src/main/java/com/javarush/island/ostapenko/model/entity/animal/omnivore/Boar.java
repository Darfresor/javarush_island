...
public class Boar extends Animal {
    ...
    private static final int MAX_CREATURE_IN_CELL = 50;
    private static final int CELL_PER_TURN = 2;
    private static final float FOOD_TO_BE_SATIATED_IN_KG = 50;


    public Boar(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfBoarInCell(){
        return MAX_CREATURE_IN_CELL;
    }
