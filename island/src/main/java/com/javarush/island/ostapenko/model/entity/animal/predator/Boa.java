...
public class Boa extends Animal {
    ...
    private static final float MAX_WEIGHT_IN_KG = 15;
    private static final int MAX_CREATURE_IN_CELL = 30;
    private static final int CELL_PER_TURN = 1;
    private static final float FOOD_TO_BE_SATIATED_IN_KG = 3;


    public Boa(String speciesName, int age, Gender gender, float weightInKg,
    ...
    public static int getMaxNumberOfBoaInCell(){
        return MAX_CREATURE_IN_CELL;
    }
