...
//TODO вынести в конфиг такие параметры как данные о животных, вероятности размножение и прочее для получения данных при инициализации
//TODO Сделать сервисы поведения парралельными при этом блок производить на уровне конкретного животного, чтобы не было конкуренции.
